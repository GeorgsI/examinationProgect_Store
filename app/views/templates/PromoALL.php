                        ...
                        $out .="
                            ...
                            <!--a href='index.php?page=PageCardProduct&num={$value['id_goods']}'-->
                              <a href='/store/CardProduct/{$value['id_goods']}'>";
                                ...
                                if((double)$value['promoPrise']!== 0.00 ){
                                $out .="<span class='mark'>".round(((double)$value['priceRose']/(double)$value['promoPrise']-1)*100)."% {$value['label']}</span>
                                    <span class='superPrise__item-photo-wrepper'>";
                                }
                                else{
                                    $out .="<span class='mark'>{$value['label']}</span>
                                    <span class='superPrise__item-photo-wrepper'>";
                                }
                                $out .="<picture>
                               ...
                               <span class='superPrise__innertextWrepper'>
                                    ...
                                    <ul class='list-price'>
                                        ...
                                        if((double)$value['promoPrise'] != 0.00){    
                                            $out .="<li class='list-price__item-newprise'>{$value['promoPrise']}<span class='currency'>BYN<span></span></li>";
                                        }   
                                    $out .="</ul>
                                </span>
                                </a>
